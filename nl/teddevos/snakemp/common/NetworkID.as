package nl.teddevos.snakemp.common 
{
	public class NetworkID 
	{
		...
		public static var LOCAL_IP_TEST:int = 888;
		...
		public static var CLIENT_INFO_REQUEST:int = 104;		//X - remoteIP#localIP#testIP
		
		public static var CLIENT_GAMETIME_MATCH:int = 110;		//X - 
		
		public static var CLIENT_DEATH_TCP:int = 121;			//X - 
		public static var CLIENT_PICKUPREQUEST_TCP:int = 122;	//X - x;y
		
		//SERVER -> CLIENT
		public static var SERVER_WELCOME:int = 100;				//X - playerID#serverName#maxplayers
		...
		public static var SERVER_INFO_RESPONSE:int = 109;		//X - time#remoteIP#localIP#testIP#serverName#players#maxplayers#lobby
		
		public static var SERVER_LOBBY_LIST_UPDATE:int = 110;	//X - player;id;ping;ready;score;rank#...
		...
		public static var SERVER_GAMETIME_START:int = 121;		//X - time;speed;size#1$name$X$Y$D$L;2...
		...
		//CLIENT -> SERVER
		public static var CLIENT_GAMETIME_REQUEST:int = 200;	//X - gametime;starttime
		
		public static var CLIENT_SNAKE_UPDATE:int = 210;		//X - frame#x;y;d$x;y;d$x;y;d#length#extra
		public static var CLIENT_DEATH_UDP:int = 211;			//X - 
		public static var CLIENT_PICKUPREQUEST_UDP:int = 212;	//X - x;y
